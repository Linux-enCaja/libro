...
\begin{figure}[h]
 \begin{center} \includegraphics[scale = .35]{./images/applications} \end{center}
  \caption{Algunas aplicaciones de los Sistemas Embebidos \textbf{FALTA REFERENCIA Y AÑO}}\label{apps}
\end{figure}
...
\begin{figure}[htp]
 \begin{center} \includegraphics[scale = .16]{./images/vdc_embedded_dev_company_size} \end{center}
  \caption{Número promedio de desarrolladores por compañía. Fuente: Venture Development Corp. \textbf{FALTA REFERENCIA Y AÑO}}
